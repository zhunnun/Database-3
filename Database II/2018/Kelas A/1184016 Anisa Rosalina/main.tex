...
\title{\large TUGAS DATABASE II \\ LAPORAN APLIKASI AKADEMIK SEDERHANA  \\[3ex]     %your thesis title,
        \textit}   %note \\[1ex] is a line break in the title

\author{Anisa Rosalina}             %your name
\college{D4 TI 2A \\ 1.18.4.016 \\[5ex]
\textit} %your college

%\renewcommand{\submittedtext}{change the default text here if needed}
\degree{Politeknik Pos Indonesia \\ Bandung}     %the degree
