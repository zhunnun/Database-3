...
\title{\large LAPORAN RANGKUMAN PEMBUATAN DATA EXCEL DAN APLIKASI APEX \\[3ex]     %your thesis title,
        \textit{Basis Data} II}   %note \\[1ex] is a line break in the title

\author{Josuansef Pardede 1184091}             %your name
\college{
\textit{\\ Tugas Oracle Database Application Express pertemuan ke-5 }} %your college
